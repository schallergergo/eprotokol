...

{
    ...
    {
        $result->resultphoto->where("deletead",0)->sortBy("created_at");
    ...
    public function ResultLog($result_id,$mark,$assessment,$filled=true){
...

    {
      ...
      switch ($typeofevent) {
        ...
        if (!$filled) $this->deleteImages($result);
    ...
    public function search(){
     ...
     private function deleteImages(Result $result){

        $photos = $result->resultphoto;
