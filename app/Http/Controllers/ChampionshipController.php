...
use App\Http\Controllers\ChampionshipType\PKDressage2OutOf3Controller;
...

{
...

    {
        ...
        $activeChampionships = Championship::orderBy("rank")->where("active", 1)
            ->paginate(20);

        $closedChampionships = Championship::orderBy("rank")->where("active", 0)
            ->paginate(20);
...

    {
        ...
        $newChampionship->rank = $newChampionship->id;
...

    {
        ...
        if ($championship->type == "pkdressage2out3") $controller = new PKDressage2OutOf3Controller();
...

    {
        ...
        $competitions = Competition::where("discipline", $championship->discipline)
