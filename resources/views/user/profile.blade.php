                ...
                <div class="card-body">
                    <form method="POST" action="/user/update/{{$user->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="username" class="form-control" name="username" value="{{ $user->username}}" disabled>
                        ...
                        <div class="form-group row">
                            <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('Club') }}</label>
                            <div class="col-md-6">
