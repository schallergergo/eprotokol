        ...
        <div class="col-md-12">
            ...
            <div class="card">
                       ...
                       <div class="row mb-2 ">
                            ...
                            <div class="col-md-3 p-1 border">
                                ...
                                <div class="col-md-2 p-1 border">
                                    ...
                                    <span class=" font-weight-bold">{!!$events[0]!!}</span>
                                 ...
                                 <div class="col-md-2 p-1 border">
                                    ...
                                    <span class=" font-weight-bold">{!!$events[1]!!}</span>
                                 ...
                                 <div class="col-md-2 p-1 border">
                                    ...
                                    <span class=" font-weight-bold">{!!$events[2]!!}</span>
                                 ...
                                 <div class="col-md-2 p-1 border">
                                    ...
                                    <span class=" font-weight-bold">{!!$events[3]!!}</span>
                ...
                <div class="card-header">
                    ...
                    <span>{{$championship->championshipname}}  </span> {{__("Not for the championship")}}
                ...
                <div class="card-body">
                    ...
                    @foreach ($doesNotHaveEverything as $club)
                        ...
                        <div class="row mb-2 ">
                            ...
                            <div class="col-md-3 p-1 border">
                                ...
                                <div class="col-md-2 p-1 border">
                                    ...
                                    <span title='{{$start[0]->event->event_name}}'>
                                ...
                                <div class="col-md-2 p-1 border">
                                    ...
                                    <span title='{{$start[1]->event->event_name}}'>
                                ...
                                <div class="col-md-2 p-1 border">
                                    ...
                                    <span title='{{$start[2]->event->event_name}}' >
                                ...
                                <div class="col-md-2 p-1 border">
                                    ...
                                    <span title='{{$start[3]->event->event_name}}' >
