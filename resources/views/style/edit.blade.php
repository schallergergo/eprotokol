            ...
            <div class="card">
                    ...
                    <form method="POST" action="/style/update/{{$style->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="given_mark" type="number" class="form-control @error('given_mark') is-invalid @enderror" name="given_mark" value="{{ $style->given_mark }}" step="any" required>
                        ...
                        <div class="form-group row">
                            <label for="deductions" class="col-md-4 col-form-label text-md-right">{{ __('Deductions') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="total_mark" class="col-md-4 col-form-label text-md-right">{{ __('Total mark') }}</label>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="eliminated" type="number" class="form-control @error('eliminated') is-invalid @enderror" name="eliminated" required> 
                                    ...
                                    <option value= @if ($style->eliminated) selected @endif>{{__("Elimnated!")}}</option>
                                </select>
                                @error('eliminated')
                                    <span class="invalid-feedback" role="alert">
                                          <strong>{{$message}}</strong>
