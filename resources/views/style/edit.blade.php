                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <label for="pony_category" class="col-md-4 col-form-label text-md-right">PK1 {{ __('Category') }}</label>



                            <div class="col-md-6">

                                <select id="pony_category" type="number" class="form-control @error('pony_category') is-invalid @enderror" name="pony_category" required> 

                                    <option value='NA'>{{__("No category")}}</option>

                                    <option value='p1' @if ($style->pony_category=='p1') selected @endif>P1</option>
                                    <option value='p2' @if ($style->pony_category=='p2') selected @endif>P2</option>
                                    <option value='nl' @if ($style->pony_category=='nl') selected @endif>NL</option>
